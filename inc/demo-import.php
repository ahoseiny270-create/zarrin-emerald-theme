...
function zarrin_demo_page() {
	...
	?>
	<div class="wrap">
		<h1>🚀 راه‌اندازی دمو — قالب زرین زمرد</h1>
...
function zarrin_demo_notice() {
	...
	<div class="notice notice-info is-dismissible" style="border-inline-start-color:#c9a227;">
		<p>
			<strong>🎉 قالب زرین زمرد فعال شد!</strong>
			...
			یا از منوی <a href="<?php echo esc_url( admin_url( 'themes.php?page=zarrin-demo' ) ); ?>">نمایش ← راه‌اندازی دمو زرین زمرد</a>
		</p>
	</div>
	<?php
}
